...
大分類<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
        套件<span class="token punctuation">{</span>
            <span class="token function">打包</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
                webpack
                babel
            <span class="token punctuation">}</span>
            <span class="token function">動畫</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
                velocity<span class="token punctuation">.</span>js
                <span class="token constant">GSAP</span>
            <span class="token punctuation">}</span>
            <span class="token function">彈窗提示</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
                popper js <span class="token comment">//alert 輕量級的套件</span>
                sweetalert2 <span class="token comment">//漂亮的 alert 自訂</span>
            <span class="token punctuation">}</span>
            <span class="token function">時間</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
                moment<span class="token punctuation">.</span>js <span class="token comment">//https://ithelp.ithome.com.tw/articles/10208995</span>
            <span class="token punctuation">}</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
...
網路<span class="token punctuation">{</span>
    ...
    <span class="token constant">URL</span><span class="token punctuation">(</span>Uniform Resource Locator<span class="token punctuation">)</span><span class="token comment">//統一資源定位符 ex: https://zh.wikipedia.org/</span>
    <span class="token constant">IP</span><span class="token punctuation">(</span>Internet Protocol Address<span class="token punctuation">)</span><span class="token comment">//網際網路協定位址 ex: 203.11.65.4</span>
    <span class="token function">IPv4</span><span class="token punctuation">(</span>Internet Protocol version <span class="token number">4</span><span class="token punctuation">)</span><span class="token comment">//8*4組 bits 2進位 如192.168.100.1</span>
    <span class="token function">IPv6</span><span class="token punctuation">(</span>Internet Protocol version <span class="token number">6</span><span class="token punctuation">)</span><span class="token comment">//16*8組 bits 16進位 如2001:0db8:86a3:08d3:1319:8a2e:0370:7344</span>

    <span class="token constant">DNS</span><span class="token punctuation">(</span><span class="token parameter">Domain Name System</span><span class="token punctuation">)</span><span class="token punctuation">{</span> <span class="token comment">//www.google.com >> 74.125.19.147 一個轉譯Domain名稱的系統</span>
        Record<span class="token punctuation">{</span>
            <span class="token constant">MX</span><span class="token punctuation">(</span>Mail Exchange<span class="token punctuation">)</span> <span class="token comment">//</span>
            <span class="token function">CName</span><span class="token punctuation">(</span>Canonical Name<span class="token punctuation">)</span>
            <span class="token constant">A</span><span class="token punctuation">(</span>Address<span class="token punctuation">)</span> <span class="token comment">//IPv4  ==host record</span>
            <span class="token constant">NS</span><span class="token punctuation">(</span>Name server<span class="token punctuation">)</span>
            <span class="token constant">TXT</span><span class="token punctuation">(</span>Text<span class="token punctuation">)</span> <span class="token comment">//驗證</span>
            <span class="token constant">AAAA</span> <span class="token comment">//IPv6 </span>
            <span class="token constant">PTR</span><span class="token punctuation">(</span>Pointer<span class="token punctuation">)</span><span class="token comment">//IP >> FQDN</span>
            <span class="token constant">SOA</span><span class="token punctuation">(</span>Start Of Authority<span class="token punctuation">)</span><span class="token comment">//只能有一個</span>
        <span class="token punctuation">}</span>
        <span class="token constant">FQDN</span><span class="token punctuation">(</span>Fully Qualified Domain Name<span class="token punctuation">)</span>
        <span class="token constant">TTL</span><span class="token punctuation">(</span>Time <span class="token constant">TO</span> Live<span class="token punctuation">)</span>
    <span class="token punctuation">}</span>

    <span class="token function">response</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token comment">//後端回應</span>
    <span class="token function">status_code</span><span class="token punctuation">(</span>ex<span class="token operator">:</span><span class="token number">404</span><span class="token punctuation">)</span><span class="token comment">//回應的狀態碼</span>

    <span class="token constant">API</span><span class="token punctuation">(</span><span class="token parameter">Application Programming Interface</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
網頁<span class="token punctuation">{</span>
    ...
    進階<span class="token punctuation">{</span>
        <span class="token constant">SPA</span><span class="token punctuation">(</span>Single Page Application<span class="token punctuation">)</span><span class="token comment">//單頁式應用 不刷新體驗好</span>
        <span class="token constant">SSR</span><span class="token punctuation">(</span>Server<span class="token operator">-</span>Side Rendering<span class="token punctuation">)</span><span class="token comment">//伺服器端渲染 加載速度快 SEO佳</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br></div></div><p><img src="https://drive.google.com/uc?export=download&amp;id=1Q9TW06Xf7AzS_d0MmdMbRcRyRelK_vfk" alt="api">
<img src="https://drive.google.com/uc?export=download&amp;id=12oFm4dk-3guNnHwOco7xNS9MCaSc-JPK" alt="DNS"></p>
</details>
<details open>
  <summary>API相關名詞</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token constant">AJAX</span><span class="token punctuation">(</span><span class="token parameter">Asynchronous JavaScript and <span class="token constant">XML</span></span><span class="token punctuation">)</span><span class="token punctuation">{</span>
<span class="token comment">// ajax技術出現解決了很早期和伺服器要資料要重新整理的問題</span>

    <span class="token constant">XHR</span><span class="token punctuation">(</span>XMLHttpRequest<span class="token punctuation">)</span><span class="token comment">//最早做法</span>

    $<span class="token punctuation">.</span><span class="token function">ajax</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token comment">//中期 jQuery作法</span>

    <span class="token function">axios</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token comment">//</span>

    <span class="token function">fetch</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token comment">// ES6 js原生操做api方法</span>

    <span class="token function">RESTful</span><span class="token punctuation">(</span><span class="token parameter">Representational State Transfer</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token keyword">get</span> post put patch <span class="token keyword">delete</span>
    <span class="token punctuation">}</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token constant">HTTP</span><span class="token punctuation">(</span><span class="token parameter">HyperText Transfer Protocol</span><span class="token punctuation">)</span><span class="token punctuation">{</span><span class="token comment">//超文本傳輸協定 往返“瀏覽器”與“伺服器”的通訊協議</span>
    ...
    <span class="token constant">HTTPS</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span><span class="token comment">//S是Secure的意思 需要SSL/TLS加密</span>
        ...
        <span class="token constant">SSL</span>購買種類<span class="token punctuation">{</span>
            ...
            頒發憑證<span class="token punctuation">{</span>
                <span class="token string">'Lets Encrypt'</span>
                <span class="token string">'DigiCert'</span>
            <span class="token punctuation">}</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br></div></div><p><a href="https://zh.wikipedia.org/wiki/%E5%82%B3%E8%BC%B8%E5%B1%A4%E5%AE%89%E5%85%A8%E6%80%A7%E5%8D%94%E5%AE%9A" target="_blank" rel="noopener noreferrer">ssl wiki<OutboundLink/></a>
