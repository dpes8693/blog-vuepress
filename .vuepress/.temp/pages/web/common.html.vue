...
<p>GET 的請求應用於從後端取得資料。</p>
<p>POST 的請求用於提交資料至後端。</p>
<p>PATCH 的請求用於套用資料至後端修改。</p>
<p>DELETE 的請求用於刪除後端指定資料</p>
<hr>
<p>2XX 系列
2XX 系列代表 server 端有成功接受到請求。</p>
<p>200 OK
請求已成功，且馬上回傳資料。</p>
<p>3XX 系列
3XX 系列代表重新導向，這類的 status code 需要 client 端進行更進一步的操作才能完成請求，譬如登入後會重新導向至首頁之類的操作。</p>
<p>4XX 系列
4XX 系列代表 client 端有錯誤。</p>
<p>404 Not Found
