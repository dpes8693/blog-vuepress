<template><h1 id="markdown-語法"><a class="header-anchor" href="#markdown-語法">#</a> Markdown 語法</h1>
<hr>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><nav class="table-of-contents"><ul><li><RouterLink to="#table-of-content">Table of Content</RouterLink></li><li><RouterLink to="#強調">強調</RouterLink></li><li><RouterLink to="#code-分隔">Code 分隔</RouterLink></li><li><RouterLink to="#youtube">YouTube</RouterLink></li><li><RouterLink to="#項目符號">項目符號+-</RouterLink></li><li><RouterLink to="#引用">引用&gt;</RouterLink></li><li><RouterLink to="#pic">pic</RouterLink></li><li><RouterLink to="#emoji">emoji</RouterLink></li><li><RouterLink to="#tip-warning-danger">tip warning danger</RouterLink></li><li><RouterLink to="#table">table</RouterLink></li><li><RouterLink to="#展開">展開</RouterLink></li><li><RouterLink to="#收合">收合</RouterLink></li><li><RouterLink to="#插入語法補充">插入語法補充</RouterLink></li></ul></nav>
<!-- end toc -->
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> bar <span class="token operator">=</span> <span class="token string">'bar'</span><span class="token punctuation">;</span>
...
</span></span></code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><table>
<thead>
<tr>
<th>Tables</th>
<th>Are</th>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>1a
2b
3c
4d
5e
