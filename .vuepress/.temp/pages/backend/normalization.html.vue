...
<ul>
<li>這邊有一個表格<code>HOLO生課程資料</code>，請試著幫我將 PHP 學分改成<code>3學分</code></li>
</ul>
<table>
<thead>
<tr>
...
<h2 id="不好的設計會導致-異常狀況-anomaly"><a class="header-anchor" href="#不好的設計會導致-異常狀況-anomaly">#</a> 不好的設計會導致 異常狀況(Anomaly)</h2>
<ul>
<li>更新異常 ex 改 PHP 學分 2=&gt;3 要改很多筆資料</li>
<li>插入異常 ex 只想新增 jQuery 課程發現缺一堆資料</li>
<li>刪除異常 ex 刪除一位學生 成績記錄就沒了</li>
</ul>
...
<ul>
<li>可以先記成一個代號，透過這個代號可以取得很多相關的資料</li>
</ul>
</li>
</ul>
<p>範例如下</p>
...
<td>dpes8693</td>
<td>Richard</td>
<td>dpes8693@gmail.com</td>
</tr>
<tr>
<td>hentai123</td>
<td>態變太</td>
<td>hentai123@gmail.com</td>
</tr>
</tbody>
</table>
</details>
...
<ul>
<li>符合 1NF</li>
<li>將部分相依的資料拆分出去(分類分起來)</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>先把<code>學生</code>拆出來</p>
</div>
<table>
<thead>
<tr>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>之後再拆 <code>課程</code> <code>成績</code> 變成三部分(課程補上編號)</p>
</div>
<table>
<thead>
<tr>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>加入<code>老師編號</code>後 發現 <code>老師姓名</code> 有遞移關係，應該將老師抽出來，未來比較好擴充</p>
</div>
<table>
<thead>
<tr>
...
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<p>從原本的 1 張表 拆成 4 張表 擴充性大幅提升!
回到上面問的 2 個問題</p>
<ul>
<li>請試著幫我將 PHP 學分改成<code>3學分</code></li>
<li>幫我新增一個課程 <code>jQuery 2學分 必修</code></li>
</ul>
<p>是不是都只要改一次就好了呢?</p>
</div>
<p><img src="https://drive.google.com/uc?export=download&amp;id=1CkGb1GdJpKv-kv736Ws-0ePhruRb8I8u" alt="完成比較圖"></p>
...
<p><a href="https://www.twblogs.net/a/5db3328ebd9eee310da02e92" target="_blank" rel="noopener noreferrer">ERD img example<OutboundLink/></a></p>
<p><a href="https://codertw.com/%E8%B3%87%E6%96%99%E5%BA%AB/123167/" target="_blank" rel="noopener noreferrer">資料庫設計筆記<OutboundLink/></a></p>
</template>