...
<p>人生第二次組電腦，為了做專題用 13500NT 組了一台 STX 的 PC，大學生沒甚麼錢盡量動手 DIY 改造成符合自己需求的樣子! 特別寫 2 篇記錄。</p>
<hr>
...
<p>組電腦沒買 win10，網路上的答案眾說紛紜，不如自己實驗一下究竟沒買 win10 會? 點閱很高的一篇文章。</p>
<hr>
...
桌子是拿用不到的木板和書拼湊出來
圖一可以看到左邊有一個<span class="token url">[<span class="token content">羅技 G923 方向盤</span>](<span class="token url">o</span>)</span>
