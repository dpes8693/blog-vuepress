...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>VHD 虛擬hard disk
BCD boot configuration data 開機選項easyBCD
雙系統開機引導

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>查詢開機關機 <code>事件碼30,7002</code></p>
</template>